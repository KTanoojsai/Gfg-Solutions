<h2><a href="https://www.geeksforgeeks.org/problems/number-of-factors1435/1?page=6">Number of factors</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Find the number of factors for a given integer <strong>n</strong>.<br></span><br>&nbsp;<span style="font-size: 18px;"><strong>Examples:</strong></span></p>
