<h2><a href="https://www.geeksforgeeks.org/problems/good-numbers4629/1?page=7">Good Numbers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">A number is called a good number if every digit is strictly greater than the sum of all digits to its right.</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>0 ≤ l ≤ r ≤ 10<sup>6</sup><br>0 ≤ d ≤ 9</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Mathematical</code>&nbsp;